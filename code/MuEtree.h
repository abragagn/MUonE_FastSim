...
public:
  ...
  MCpara() :
    SampleTag(0), process_ID(0), Nevreq(0), UNWGT(false), nphotmode(-1),
    radmuch(1), radelch(1), rnd_ext(0), rnd_int(0), Ebeam(0), EbeamRMS(0),
    EXTBEAM(false), charge_mu(0), mass_mu(0), mass_e(0), invalfa0(0),
    Emin_e(0), thmin_e(0), thmax_e(0), thmin_mu(0), thmax_mu(0), Ethr(0),
    ththr(0), i_acopl(0), cut_acopl(0), i_elast(0), cut_elast(0), Wnorm(0),
    Wmax(0), READ_COEF(true), ihadVP(0), ihadVPfl(0), Nsearch(0), Ndistr(0),
...
public:
  ...
  MCstat() :
    Nevgen(0), Nwgt(0), Nwgt_Negative(0), Swgt(0), Swgt_Negative(0),
    SQwgt(0), SQwgt_Negative(0), Nwgt_OverMax(0), WmaxTrue(0),
    Xsec(0), XsecErr(0), Xsec_Negative(0), Xsec_Negative_Err(0),
...
public:
  ...
  Particle() : pdgId(0), px(0), py(0), pz(0) {};
