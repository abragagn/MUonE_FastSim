...
public:
  Histos(const MCpara & pargen, const AN_Input & paran,
         const TString & nameDir = "MuE", const TString & namePrefix = "",
         const bool make_dirs = true, bool debug = false);
...
private:
  ...
  TH2D* hsn_coo_mu;
  TH2D* hsn_coo_e;
  TH2D* hsn_thmu_vs_the_defAngles;
  //
  //TH1D* hsn_theX;
  //////////////////////////////////////////////////////////////////////////////
