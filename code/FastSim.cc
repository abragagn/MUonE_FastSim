...
void FastSim::Process(const MuE::Event & event,GammaFunctionGenerator* & gamma, EMECALShowerParametrization* const & myParam, ECAL* const & myGrid) {
  ...
  
  //TEST PER IL CALORIMETRO SCELGP POSIZIONE DELL'ELETTRONE NELL'ANGOLO O AL CENTRO//////////////////////////////////////////////////////
  //coordinates[1][0]=0; 
  //coordinates[1][1]=0; 
  //FINE TEST RISOLUZIONE CALORIMETRO////////////////////////////////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Double_t r_mu=sqrt((coordinates[0][0]*coordinates[0][0])+(coordinates[0][1]*coordinates[0][1]))*100; //rmu in cm

  PrepareEMShower(detKin,p_e_out_mod,photons_mod,coordinates,i,r_mu,gamma,myParam,myGrid);
...
KineVars FastSim::LoadKineVars(const PxPyPzEVector & p_mu_in,  const PxPyPzEVector & p_e_in, 
			       const PxPyPzEVector & p_mu_out, const PxPyPzEVector & p_e_out,TMatrixD & coo,TMatrixD & def_angle,TMatrixD & def_angle_smear,const Double_t & tar,const Double_t & n_phot,ECAL* const & myGrid) 
{
  
  MuonOut m = p_mu_out.E() > 0 ? DetMuonOut(p_mu_in, p_mu_out,coo,def_angle,def_angle_smear,tar,n_phot) : MuonOut();
  Electron e = p_e_out.E() > 0 ? DetElectron(p_e_in, p_e_out,coo,def_angle,def_angle_smear,myGrid) : Electron();
...
MuonOut FastSim::DetMuonOut(const PxPyPzEVector & p_mu_in, const PxPyPzEVector & p_mu_out,TMatrixD & coo,TMatrixD & def_angle,TMatrixD & def_angle_smear, const Double_t & tar,const Double_t & n_phot) const
{
  MuonOut m;
  m.Emu = p_mu_out.E();
...
Electron FastSim::DetElectron(const PxPyPzEVector & p_e_in, const PxPyPzEVector & p_e_out,TMatrixD & coo,TMatrixD & def_angle,TMatrixD & def_angle_smear,ECAL* const & myGrid) const
{
  Electron e;
  e.Ee = p_e_out.E();
...
void FastSim::LoadPhotons(const std::vector<PxPyPzEVector> & photons, TMatrixD & coo,Double_t n_photons1,const PxPyPzEVector & p_mu_in,ECAL* const & myGrid){//, std::vector<Photon> load_photons) {
...
//
void FastSim::Propagate(PxPyPzEVector & mu_in_mod,  PxPyPzEVector & mu_out_mod,  PxPyPzEVector & e_out_mod, std::vector<PxPyPzEVector> & phot_mod, TMatrixD & c, TMatrixD & def_angle,TMatrixD & def_angle_smear)
{
...
//
void FastSim::SmearSi(PxPyPzEVector & k, TMatrixD & c, const Double_t & nSi, const Double_t & before, const Double_t & id )
{
...
//
void FastSim::SmearBe(PxPyPzEVector & k, TMatrixD & c, const Double_t & f, const Double_t & before, const Double_t & id )
{
  ...
  Double_t sigBe=(13.6/(k.E()*1000))*sqrt(sBe/x0B)*(1+0.038*log(sBe/x0B)); //rad
...
//
void FastSim::BlankSpace(PxPyPzEVector & k, TMatrixD & c, const Double_t & d, const Double_t & before, const Double_t & id )
{
...
TMatrixD FastSim::Def_angle(PxPyPzEVector & p_mu_in,PxPyPzEVector & p_mu_out, PxPyPzEVector & p_e_out){
...
void FastSim::PrepareEMShower(KineVars & kv,PxPyPzEVector & e_out_mod, std::vector<PxPyPzEVector> & photons, TMatrixD & c, const Double_t & i,const Double_t & r_mu,GammaFunctionGenerator* & gamma, EMECALShowerParametrization* const & myParam, ECAL* const & myGrid)
{
