...
namespace MuE {
  ...
  public:
    ...
    MuonOut():
    Emu(0),thmu(0),phmu(0),t13(0),x13(0),cooxmu(0),cooymu(0),tar(0),def_angle_mu(0),def_angle_mu_smear(0)
      {};
    virtual ~MuonOut(){};
    ClassDef(MuonOut,1)
  };
  ...
  public:
    ...
    Electron() :
     Ee(0), the(0), phe(0), t24(0), x24(0), tt_e(0), xt_e(0), cooxe(0), cooye(0), def_angle_e(0),def_angle_e_smear(0),
     Ecell1(0),Ecell2(0),Ecell3(0),Ecell4(0),Ecell5(0),Ecell6(0),Ecell7(0),Ecell8(0),Ecell9(0),Ecell10(0),Ecell11(0),
     Ecell12(0),Ecell13(0),Ecell14(0),Ecell15(0),Ecell16(0),Ecell17(0),Ecell18(0),Ecell19(0),Ecell20(0),Ecell21(0),Ecell22(0),Ecell23(0),Ecell24(0),Ecell25(0),n_cell_e(0)
     {};
    virtual ~Electron(){};
    ClassDef(Electron,1)
  };
  ...
  public:
    ...
    KineVars():
      t13(0),t24(0),x13(0),x24(0),tt_e(0),xt_e(0),Ee(0),Emu(0),the(0),thmu(0),phe(0),phmu(0),tar(0),
      deltaPhi(0),openingAngle(0),tripleProduct(0)
      {};
    ...
    KineVars(const MuonOut & m, const Electron & e, const MuEpair & d):
      ...
      cooxmu(m.cooxmu),cooymu(m.cooymu),cooxe(e.cooxe),cooye(e.cooye),tar(m.tar),n_phot(m.n_phot),
      def_angle_mu(m.def_angle_mu), def_angle_e(e.def_angle_e),def_angle_mu_smear(m.def_angle_mu_smear),def_angle_e_smear(e.def_angle_e_smear),
      Ecell1(e.Ecell1),Ecell2(e.Ecell2),Ecell3(e.Ecell3),Ecell4(e.Ecell4),Ecell5(e.Ecell5),Ecell6(e.Ecell6),Ecell7(e.Ecell7),
      Ecell8(e.Ecell8),Ecell9(e.Ecell9),Ecell10(e.Ecell10),Ecell11(e.Ecell11),Ecell12(e.Ecell1),Ecell13(e.Ecell13),
      Ecell14(e.Ecell14),Ecell15(e.Ecell15),Ecell16(e.Ecell16),Ecell17(e.Ecell17),Ecell18(e.Ecell18),Ecell19(e.Ecell19),
      Ecell20(e.Ecell20),Ecell21(e.Ecell21),Ecell22(e.Ecell22),Ecell23(e.Ecell23),Ecell24(e.Ecell24),Ecell25(e.Ecell25),n_cell_e(e.n_cell_e),
  ...
  public:
    ...
    Photon():
    energy(-1),theta(-1),phi(0),energyCoM(-1),def_angle_ph(-1),cooxph(-1),cooyph(-1),n_cell_ph(0)
      {};
