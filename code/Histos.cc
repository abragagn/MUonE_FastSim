  ...
  dirname(nameDir),prefix(namePrefix),makedirs(make_dirs)
{
  ...
  hsn_coo_mu = new TH2D(prefix+"hsn_coo_mu","DET coordinates mu; DET #x_{mu} (m); DET #y_{#mu} (m)",200, -0.2, 0.2, 200,-0.2, 0.2);
  hsn_coo_e = new TH2D(prefix+"hsn_coo_e","DET coordinates e; DET #x_{e} (mrad); DET #y_{#e} (mrad)",200, -0.2, 0.2, 200,-0.2, 0.2);
  hsn_thmu_vs_the_defAngles = new TH2D(prefix+"hsn_thmu_vs_the_defAngles","DET #theta_{#mu} vs #theta_{e}; DET #theta_{e} (mrad); DET #theta_{#mu} (mrad)",180, 0., 30., 250, 0., 5.);
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void Histos::Plot2D(bool debug) {
  ...
  TCanvas cz_thmuVsthe_defAngles("cz_thmuVsthe_defAngles", "Muon vs Electron angle", 700, 500);
