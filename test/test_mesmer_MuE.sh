...
OPTIONS="-O2 -Wall -fconcepts"
#OPTIONS="-g -Wall"

g++ ${OPTIONS} -shared -fPIC -o libMuEtree.so -I${src} MuEtreeDict.C ${src}/MuEtree.cc ${src}/Utils.cc ${ROOTLIBS}

g++ ${OPTIONS} -o ${MAIN}.exe -I${src} -I${ROOTINCDIR} ${src}/${MAIN}.cc MuEtreeDict.C ${src}/MuEtree.cc ${src}/Inputs.cc ${src}/Analysis.cc ${src}/FastSim.cc ${src}/Utils.cc ${src}/ElasticState.cc ${src}/Histos.cc ${src}/dalpha.cc ${src}/GammaFunctionGenerator.cc ${src}/ECAL.cc ${src}/EMShower.cc ${src}/IncGamma.cc ${src}/BaseNumericalRandomGenerator.cc ${src}/RadialInterval.cc ${ROOTLIBS} -L${gen} -lmesmerfull -lgfortran -lX11
...
time ./${MAIN}.exe  mesmer.cards  input.cfi
